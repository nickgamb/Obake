...
resource "okta_group" "obake_admin" {
  name        = "Obake Admin"
  description = "(Generated by UDP)"
}
...
resource "okta_user_schema" "addSocialAttribute" {
  index  = "socialSecurityNumber"
  title  = "Social Security Number	"
  type   = "string"
  master = "PROFILE_MASTER"
}
resource "okta_user_schema" "addBusinessNumberAttribute" {
  index  = "businessNumber"
  title  = "Business Number"
  type   = "string"
  master = "PROFILE_MASTER"
}
resource "okta_user_schema" "addAccountNumberAttribute" {
  index  = "accountNumber"
